...
import com.example.kumowaladmin.databinding.ActivityLoginBinding
...
class LoginActivity : AppCompatActivity() {
    ...
    private fun validateUser (username : String, password : String,callback: (Boolean) -> Unit) {
        ...
        val url = "https://kumowal.my.id/api_admin/user_validate_login.php?username=$username&password=$password"
                ...
                try {
                    ...
                    when (status) {
                        "berhasil" -> {
                            ...
                            SP.setLoginPengguna(response.getJSONObject(1).getString("admin_id"))
                            callback(true)
                        }
